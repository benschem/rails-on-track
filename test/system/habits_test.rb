...
class HabitsTest < ApplicationSystemTestCase
  ...
  test "should create habit" do
    ...
    fill_in "Cold streak", with: @habit.cold_streak
    fill_in "Date last done", with: @habit.date_last_done
    check "Done today" if @habit.done_today
    fill_in "Hot record", with: @habit.hot_record
    fill_in "Hot streak", with: @habit.hot_streak
